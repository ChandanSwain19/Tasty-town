...
import com.tastytown.backend.service.impl.IImageService;
...
@Tag(name = "Image API", 
                        description = "This controller class responsible for extracting the food image")
...
@RequiredArgsConstructor
 public class ImageController {
    ...
    @Operation(summary = "Extract food image by filename")
