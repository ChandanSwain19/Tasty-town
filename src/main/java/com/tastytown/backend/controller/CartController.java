...
public class CartController {
    ...
    @PutMapping
    public ResponseEntity<CartResponseDTO> updateCartItemsQuantity(@RequestAttribute String userId, @RequestBody CartItemRequestDTO dto) {
    ...
    @DeleteMapping
    @Transactional
    public ResponseEntity<Void> clearCartItemOfAnUser(@RequestAttribute String userId) {
