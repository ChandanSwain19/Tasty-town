...
public class FoodMapper {
    ...
    public static Food convertToEntity(FoodRequestDTO requestDTO, 
       ...
       return Food.builder()
                ...
                .foodDescription(requestDTO.foodDescription()) // Make sure Food.FoodBuilder has this method, or replace with the correct setter method as defined in Food entity, e.g., .description(requestDTO.foodDescription())
